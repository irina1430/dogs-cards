...
export default function DogCard({ dog, toggleLike, removeDog }: DogCardProps) {
  return (
    <Link href={`/${dog.id}`} className="block">
      <Card className="relative overflow-hidden flex flex-col items-center bg-[#F5F5F5] hover:shadow-lg hover:bg-[#E6E6FA] cursor-pointer] h-[400px]">
        <Button
          variant="ghost"
          size="icon"
